...
class Settings(BaseSettings):
    ...
    # API Keys (Optional)
    RIVALZ_API_KEY: str | None = Field("eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjY4YTk1Mjc0YmVlOWE5Y2I0MTQ3Mzg3ZSIsImlhdCI6MTc1NTkyNzE1NiwiZXhwIjoxNzg3NDg0NzU2fQ.Hzg5Wy7slRcy0VH2zMllMfD2NV_1KGAdekDfXHQGjTI", description="Rivalz ADCS API key for price oracle access")
    SEITRACE_API_KEY: str | None = Field("124f5fe0-69b4-45ab-9c1e-f02fa3e898c8", description="SeiTrace API key for enhanced explorer features")
    ELIZA_OS_API_KEY: str | None = Field("b838c71b1f3d2dcd3b27574ff303fd06de6d380a2e79d311beba31b40244f02d", description="ElizaOS API key for enhanced AI recommendations")
    
    # ElizaOS Configuration
    ELIZA_API_URL: str = Field("https://elizaos.ai/api", description="ElizaOS API endpoint URL")
    ELIZA_API_KEY: str = Field("b838c71b1f3d2dcd3b27574ff303fd06de6d380a2e79d311beba31b40244f02d", description="ElizaOS API key for AI advisory services")
